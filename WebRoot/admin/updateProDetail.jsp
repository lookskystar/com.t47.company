...
<%  
	...
	if(productIdStr==null||"".equals(productIdStr)){
	  ...
	  if(fileName==null||"".equals(fileName)){
		fileName=product.getPicture().substring(product.getPicture().lastIndexOf("/")+1);
	}else{
	    //fileName
	}
...
<!--头结束-->
<!--主体开始-->
<div style=" width:750px; height:18px;" align="left"></div>
<table width="750" height="380" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="152" rowspan="2" valign="top" id="left" style="padding-left:10px; padding-top:10px;border:1px #FF0000 solid; border-style:solid; background-color:#f4f8fc;"><%@ include file="../commons/menuAdmin.jsp" %>	<br></td>
	
    <td width="26" rowspan="2" valign="top"> 
		<div style="background-image:url(${ctx}/image/feir.gif); width:20px; height:32px;" onClick="menuDivNone()"></div>
		<br></td>
    <td width="400" height="39" align="left" valign="top" style="padding-left:10px; padding-top:15px;">
	<div style="width:600px; height:20px;"><img src="${ctx}/image/ico_oversea.gif" />修改商品</div>	</td>
  </tr>
  <tr>
    <td valign="middle" style="padding-left:10px; padding-top:15px;" align="center">
	<form name="myForm" id="myForm" action="updateProDetailAction.jsp" method="post" onSubmit="return checkPro()" >
	<input type="hidden" name="productId" id="productId" value="<%=productId %>">
	  <table width="533" border="0" cellpadding="0" cellspacing="0" >
        ...
        <tr>
          <td colspan="4" align="center">修改商品</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td width="190" align="left" style="color:#FF0000"><input type="text" class="text" name="seriaNumber" id="seriaNumber" value="<%=product.getSerialNumber() %>" readonly="readonly"></td>
        ...
        <tr>
          <td width="109" align="right">商品名称：</td>
          <td width="12">&nbsp;</td>
          <td><span style="color:#FF0000">
            <input name="proName" type="text" class="text" id="proName" onBlur="LostFocusCheckProName()" value="<%=product.getNames() %>" maxlength="10">
          </span></td>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td><span style="color:#FF0000">
            <input name="proBrand" type="text" class="text" id="proBrand" onBlur="LostFocusCheckProBrand()" value="<%=product.getBrand() %>" maxlength="10">
          </span></td>
          <td id="errorbrand">&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td >&nbsp;</td>
          <td ><span style="color:#FF0000">
            <input name="proModel" type="text" class="text" id="proModel" onBlur="LostFocusCheckProModel()" value="<%=product.getModel() %>" maxlength="10">
          </span></td>
		  <td id="errormodel">&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td >&nbsp;</td>
          <td ><span style="color:#FF0000">
            <input name="proPrice" type="text" class="text" id="proPrice" onBlur="LostFocusCheckProPrice()" value="<%=new DecimalFormat("0.00").format(product.getPrice())%>" maxlength="7">
            ￥
          </span></td>
		  <td id="errorprice"><font color='red'>价格格式如：（8888.88）</font></td>
        </tr>
        <tr>
          <td colspan="4" align="center">&nbsp;</td>
        </tr>
        <tr>
          ...
          <td >&nbsp;</td>
          <td colspan="2" ><table width="395" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="342"><textarea name="proDescriptions" cols="45" rows="8" id="proDescriptions" style="border:1px #0099FF solid;" onBlur="LostFocusCheckProDescriptions()"><%=product.getDescriptions() %></textarea></td>
                <td width="53"></td>
              </tr>
              <tr>
        ...
        <tr>
          <td colspan="4" align="center"><input type="submit" name="Submit" value="更  新" style="border:none; background-color:#FF9933; padding-top:0px;">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<!--tu层设置开始-->
<DIV class="search-top" id="head" style="display:none; width:615px; left:192px; top:197px; position:absolute;  border-left::1px #0000FF solid; height: 200px;" onMouseDown="init('head');mouseDowning()" onMouseUp="mouseUping()">
...
<div style="width:614px; height:200px;background-color:#FFFFFF; border-left:1px #FF0000 solid;border-right:1px #FF0000 solid;overflow-y:auto;white-space:nowrap;" >
