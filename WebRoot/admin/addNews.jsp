...
<table width="750" height="380" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<div style="width:600px; height:20px;"><img src="${ctx}/image/ico_oversea.gif" />发布新闻</div>	</td>
  </tr>
  <tr>
    <td valign="middle" style="padding-left:10px; padding-top:15px;" align="center">
	<form name="myForm" id="myForm" action="addNewsAction.jsp" method="post" onSubmit="return checkNews()">
	  <table width="533" border="0" cellpadding="0" cellspacing="0" >
        ...
        <tr>
          <td colspan="4" align="center">发布新闻</td>
        </tr><tr>
          <td colspan="4" align="center">&nbsp;</td>
        </tr><tr>
          <td align="right" style="color:#FF0000">&nbsp;</td>
          <td align="left" style="color:#FF0000">&nbsp;</td>
          <td width="251" align="left" style="color:#FF0000">&nbsp;</td>
          <td align="left" style="color:#FF0000">&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          <td width="135" align="right">新闻名称：</td>
          <td width="13">&nbsp;</td>
          <td><span style="color:#FF0000">
            <input name="newsName" type="text" class="text" id="newsName" maxlength="10" onBlur="LostFocusCheckNewTitle()">
          </span></td>
        ...
        <tr>
          ...
          <td colspan="2" ><table width="381" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="340">
                <textarea name="newsContent" cols="45" rows="15" id="newsContent" style="border:1px #0099FF solid;" onBlur="LostFocusCheckContent()"></textarea>
        ...
        <tr>
          <td colspan="4" align="center"><input type="submit" name="Submit" value="发  布" style="border:none; background-color:#FF9933; padding-top:0px;">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="reset" name="res" value="重  置" style="border:none; background-color:#FF9933; padding-top:0px;" >          </td>
        </tr>
        <tr>
