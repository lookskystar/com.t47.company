...
<%
	...
	//分页
                ...
                p = Integer.parseInt(pStr); //获得当前页面数
             	...
             	int num = newsDao.findCountNews(); //取得该新闻条数
                 ...
                 //分页
                  function findPage(page,pageCount){
		            ...
		            if(page>pageCount){
			  		...
			  		location.href="updateNews.jsp?page="+page;
			  		}
  ...
  <tr>
    <td><table width="750" height="300" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="622" height="39" align="left" valign="top" style="padding-left:10px; padding-top:15px;"><img src="${ctx}/image/ico_oversea.gif" />更新新闻</td>
      </tr>
      <tr>
        <td valign="top" style="padding-left:10px;" align="left"><table width="585" border="0" cellpadding="0" cellspacing="0" >
            ...
            <tr>
              <td width="137" align="center" style="font-size: 13px; color: blue; font-weight:600;">新闻标题</td>
              <td width="212" align="center" style="font-size: 13px; color: blue; font-weight:600;">发布时间</td>
              <td width="100" align="center" style="font-size: 13px; color: blue; font-weight:600;">修改</td>
      ...
      for(int i=0;i<newsList.size();i++){
       ...
       %>
            <tr>
              <td align="left" bgcolor="#EEEEEE" style="border-bottom:3px #FFFFFF solid;  padding-top: 3px;">&nbsp;&nbsp;<%=news.getTitle()%></td>
              <td align="center" bgcolor="#EEEEEE" style="border-bottom:3px #FFFFFF solid;  padding-top: 3px;"><%=news.getPublishTime()%></td>
              <td align="center" bgcolor="#EEEEEE" style="border-bottom:3px #FFFFFF solid;  padding-top: 3px;"><a href="updateNewsDetail.jsp?newsID=<%=news.getNewsId()%>">修改</a></td>
              <td align="center" bgcolor="#EEEEEE" style="border-bottom:3px #FFFFFF solid;  padding-top: 3px;"><a href="updateNewsDelAction.jsp?newsID=<%=news.getNewsId()%>&title=<%=news.getTitle()%>">删除</a></td>
            </tr>
            <%
      }
       %>
