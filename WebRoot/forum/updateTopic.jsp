...
if((boardIdStr==null||"".equals(boardIdStr))||(userIdStr==null||"".equals(userIdStr))||(topicIdStr==null||"".equals(topicIdStr))||(loginUserIdStr==null||"".equals(loginUserIdStr))){
		}else{
		...
		<div style="width: 953px; height: 620px;" align="center">
			<div style="width: 750px; height: 450px;  align="center">
				...
				<div style="width: 750px; height: 180px;">
					<form action="doUpdateTopic.jsp?" id="myForm" name="myForm" method="post" onSubmit="return check()">
					  ...
					  <table width="750" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tbody>
                          ...
                          <tr align="left">
							...
							<table width="750" height="442" border="0" cellspacing="0" style="border-left:1px #FF0000 solid; border-right:1px #FF0000 solid;">
                              <tr>
                                <td width="36" height="33" align="center">标题<br>                                </td>
                                <td width="534" > 
                                 &nbsp;&nbsp;&nbsp;<input type="text" name="titleName" id="titleName" size="50" onBlur="checkTitleName()" class="register-input"  onMouseOver="this.className='mouseOverStyle'" onMouseOut="this.className='mouseOutStyle'" readonly="true" value="<%=topic.getTitle() %>"> </td>
                              ...
                              <tr>
                                ...
                                <td height="386" colspan="2" align="right" valign="top" >                            
&nbsp;
<!--  
<textarea name="content"  id="content" cols="70" rows="15" style="border: 1px #FF6666 solid; overflow-y:visible;overflow-x:hidden;width: 680px;height: 380px;  " wrap="hard"><%=topic.getContent() %></textarea>
							  ...
							  -->							
							  <script type="text/javascript">
                               var contentTxt='<%=topic.getContent()%>';   //得到回复内容的String类型
							   var oFCKeditor=new FCKeditor('content');
                              ...
                              <tr>
                                <td colspan="2" align="right" valign="top" >（不能大于：1000字）&nbsp;&nbsp;</td>
                              </tr>
                            </table>
