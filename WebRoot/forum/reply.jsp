...
<%
	...
	try{
		...
		String topicIdStr=request.getParameter("topciId");
	
		if((boardIdStr==null||"".equals(boardIdStr))||(topicIdStr==null||"".equals(topicIdStr))){
		}else{
...
-->
    ...
    <script type="text/javascript">
    	...
    	window.onload=function(){	
    		...
    		//alert(oFCKeditor.Value.length);
    		//ofcValue=oFCKeditor.Value;
...
//////////////////////////////////////////////////////////
			...
			function checkContent(){
			    //alert("cfk:-"+oFCKeditor.Value);
			    var cname=document.myForm.content.value;
			    if(cname.length<10){
			    	window.alert("内容不能少于10个字!");
			    	return false;
			    }
			    if(cname.length>1000){
			    	window.alert("内容不能大于一千字!");
			    	return false;
			    }
			    else{
			    	//window.alert("成功！");
					  ...
					  <table width="750" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tbody>
                          <tr>
                            ...
                            &nbsp;&nbsp;<font size="3px" color="#FFFFFF" face="黑体">回&nbsp;新&nbsp;贴</font>&nbsp;&nbsp;<br>                            </td>
                          </tr>
                          <tr align="left">
							...
							<table width="750" height="267" border="0" cellspacing="0" style="border-left:1px #FF0000 solid; border-right:1px #FF0000 solid;">
                              <tr>
                                <td width="35" height="33" align="center">标题<br>                                </td>
                                <td width="530" > &nbsp;
 ...
 <!--  
&nbsp;<textarea name="content"  id="content" cols="90" rows="15" style="overflow-y:visible;overflow-x:hidden;border: 1px #FF6666 solid;" wrap="hard"></textarea>
-->
							<script type="text/javascript">
							   var oFCKeditor=new FCKeditor('content');
